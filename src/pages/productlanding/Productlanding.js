...
const ProductLanding = () => {
  ...
  useEffect(() => {
    // Mock local products with images from Unsplash (same products from Slider.js)
    const localProducts = [
    ...
    <section className='r-wrapper'>
      <div className='paddings innerWidth r-container'>
        <div className='r-head'>
          <span className='orangeText'>Exclusive Products</span>
          <span className='primaryText'>Shop Now with Amazing Discounts</span>
        </div>
